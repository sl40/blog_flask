(function () {
    ...
    var J = /(.*?)\*(.*?)\*(.*)/, K = /([^?#]+)(\?[^#]*)?(#.*)?/, L = /(.*?)(^|&)_gl=([^&]*)&?(.*)/, N = function (a) {
        ...
        return function (b) {
            var c = z(t.location.href), d = c.search.replace("?", "");
            a:{
                var e = d.split("&");
        ...
        if ("cookie" == P(a, ac)) {
            ...
            if (a.get(je) && (c = a.get(ce), d = a.get(ie), !c || d && "aw.ds" != d)) {
                ...
                if (M) {
                    ...
                    e = {};
                    if (d && d.length) for (g = 0; g < d.length; g++) (ca = d[g].value.split("."), "1" != ca[0] || 3 != ca.length) ? c && (c.na = !0) : ca[1] && (e[d[g].ja] ? c && (c.pa = !0) : e[d[g].ja] =
